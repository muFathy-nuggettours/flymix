	...
	<tr>
		<td>
			...
			<div class="input force-ltr" data-icon="&#xf3cd;">
				...
				&nbsp;&nbsp;<input type=number name=mobile value="<?=str_replace($logged_user["mobile_prefix"], [], $logged_user["mobile"])?>" maxlength=11 placeholder="<?=readLanguage('accounts','mobile_placeholder')?>" data-validation=validateMobile>
			</div>
			<script>
				//Set Default Value
